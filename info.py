...
URL = "https://cc-p5hw.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://cc-p5hw.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://cc-p5hw.onrender.com/".format(FQDN)
else:
    URL = "https://cc-p5hw.onrender.com/".format(FQDN)
