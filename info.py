...
auth_channel = environ.get('AUTH_CHANNEL'-1002085915530)
auth_grp = environ.get('AUTH_GROUP'-1001728906556)
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID'-1001819957235)
...
URL = "https://filestream-filestreambot.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filestream-filestreambot.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filestream-filestreambot.koyeb.app/".format(FQDN)
else:
    URL = "https://filestream-filestreambot.koyeb.app/".format(FQDN)
